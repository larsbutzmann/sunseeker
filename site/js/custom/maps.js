...
function setRadar() {
    ...
    // var url = "http://api.wunderground.com/api/17cf732ee8929251/radar/image.png?maxlat=" + neBound.lat() + "&maxlon=" + neBound.lng() + "&minlat=" + swBound.lat() + "&minlon=" + swBound.lng() + "&width=" + $(window).width() + "&height=" + $(window).height();
    var url = "http://radblast.wunderground.com/cgi-bin/radar/WUNIDS_composite?maxlat=" + neBound.lat() + "&maxlon=" + neBound.lng() + "&minlat=" + swBound.lat() + "&minlon=" + swBound.lng() + "&width=" + $(window).width() + "&height=" + $(window).height() + "&type=00Q&frame=0&num=1&delay=25&png=1&min=0&rainsnow=1&nodebug=0&brand=wundermap&smooth=1&noclutter=1&radar_bitmap=1";
